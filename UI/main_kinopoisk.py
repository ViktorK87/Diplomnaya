...
class Kinopoisk:
    ...
    def input_movie_title(self, title: str) -> str:
        ...
        search = self._driver.find_element(
            By.CSS_SELECTOR, "[data-tid = 'SearchButton']")
        search.click()
    ...
    def movie_details(self, title) -> str:
        ...
        self._driver.find_element(By.CSS_SELECTOR,
                                  "#suggest-item-0,"
                                  "[href='/film/"
                                  "492c446642bf8dc88f0abcb9a4b02f7f]")\
            .click()
        self._driver.implicitly_wait(4)
    ...
    def button_login(self):
        ...
        login = WebDriverWait(self._driver, 15).until(
            EC.presence_of_element_located((
                    By.CSS_SELECTOR,
                    "a.Link_root__Z3NLP.LoginLink_root__72GCB")))
        login.click()
    ...
    def button_subscription(self) -> str:
        ...
        subscr_btn = WebDriverWait(self._driver, 10).until(
            EC.presence_of_element_located((
                By.CSS_SELECTOR,
                ".style_button__PNtXT.style_buttonSize48__7RF4w"
            )))
